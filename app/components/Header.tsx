  ...
  return (
    <header className="bg-white w-full shadow-sm">
      <nav className="w-full px-4 py-4 lg:px-7 flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="mt-4 flex flex-col md:hidden space-y-2 w-full">
            <a href="#" className="text-gray-700 hover:text-[#01627d]">Our Services</a>
            <a href="#" className="text-gray-700 hover:text-[#01627d]">Find Work</a>
            <a onClick={() => router.push("/jobs")} className="text-gray-700 hover:text-[#034C53]">Find Jobs</a>
            <a onClick={() => router.push("/post-job")} className="text-gray-700 hover:text-[#034C53]">Post Jobs</a>
          </div>
        )}
      </nav>
    </header>
